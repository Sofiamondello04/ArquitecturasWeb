...
public class LoadDatabase {
    ...
    @Bean
    CommandLineRunner initDatabaseFromCSVCarreras(
        ...
        return args -> {
            ...
            try (InputStream inputStream = LoadDatabase.class.getClassLoader().getResourceAsStream(csvFilePath);
                ...
                for (CSVRecord csvRecord : csvParser) {
                    ...
                    // Crear Estudiante
                    Estudiante estudiante = new Estudiante(dni, nombre, apellido, edad, genero,
                            ciudad, numLibretaUniversitaria, null);
    ...
    /* 
     @Bean
     CommandLineRunner initDatabaseFromCSVInscripciones(
         ...
         return args -> {
             ...
             try (InputStream inputStream = LoadDatabase.class.getClassLoader().getResourceAsStream(csvFilePath);
                 ...
                 for (CSVRecord csvRecord : csvParser) {
                     ...
                     Estudiante e = 
                     // Crear Carreras
                     Inscripcion i = new Inscripcion(id, id_estudiante, id_carrera, inscripcion, graduacion, antiguedad);
    ...
    @Bean
    CommandLineRunner initDatabase3(@Qualifier("inscripcionRepository") InscripcionRepository repository) {
        return args -> {
            log.info("Preloading " + repository.save(new Inscripcion()));
        };
    }
*/
}